...
namespace NBitcoin.Crypto
{
	public class ECKey
	{
		...
		static ECKey()
		{
			_Secp256k1 = Org.BouncyCastle.Crypto.EC.CustomNamedCurves.Secp256k1;
    ...
    public ECDSASignature Sign(byte[] hash, bool useLowR = true)
    {
      AssertPrivateKey();
      var signer = new DeterministicECDSA(useLowR);
      signer.setPrivateKey(PrivateKey);
    ...
    private void AssertPrivateKey()
		...
		public static ECKey RecoverFromSignature(int recId, ECDSASignature sig, uint256 message, bool compressed)
		{
			...
			var prime = ((SecP256K1Curve)curve.Curve).Q;
